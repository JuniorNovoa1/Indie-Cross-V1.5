...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Cuphead Dodge', "Value 1: How much time you have to dodge (0.35 is used if blank) \nValue 2: If you want mugman to die\nput 'true' if not then leave blank"],
		['Camera Tween Zoom', "Value 1: How much to zoom in. (Doesn't change back after) \n Value 2: How much time to zoom in."],
		['Cuphead Dodge 2', "Value 1: Useless \nValue 2: Useless"],
		['Cuphead Shoot', "Value 1: Useless \nValue 2: Useless"],
		['Cuphead Shoot 2', "Value 1: Useless \nValue 2: Useless"]
	];
